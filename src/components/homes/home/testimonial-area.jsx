               ...
               <div className="row">
                  <div className="col-lg-12">
                     <div className="tp-testimonial-title-wrapper text-center">
                        ...
                        <h3 className="tp-section-title">{testimonial && testimonial?.SettingTitle}
                             <span className="title-color">
                          {testimonial && testimonial?.SettingSubTitle}
                            </span>
                  ...
                  <div className="tp-testimonial-box-wrapper">
                     <div className="testimonial-active swiper-container">
                        <Swiper {...setting}>
                            {testimonial && testimonial.TestimonialOutputListVM.length>0 && testimonial.TestimonialOutputListVM.map((item, i)  => 
                                    ...
                                    <div className="tp-testimonial-user-thumb">
                                       {item?.ProfileImagePath? <Image src={ApiEndPoints.baseUrl + item.ProfileImagePath} alt="theme-pure" height={100} width={100} />:""}
                                    </div>
