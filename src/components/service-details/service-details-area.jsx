...
//   const [serviceDetailFaq,setServiceDetailFaq]=useState("")
//   const GetServiceDetailFaq=async()=>{
//    var response=await htmlcontentservice.GetFAQHomeListbyKey(1, 99, "Graycode-ServiceDetailFAQ","en")
//    if(response.Code==200){
//       setServiceDetailFaq(response.Data.FAQOutputs)
    
//    }
//   }
//   useEffect(()=>{GetServiceDetailFaq()},[])
...
//                                 {serviceDetailFaq && serviceDetailFaq.length>0 && serviceDetailFaq.map((item, i) => 
